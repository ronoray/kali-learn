...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-terminal-bg text-terminal-text font-mono">
      {/* Header */}
      <header className="border-b border-terminal-border sticky top-0 z-50 bg-terminal-bg/95 backdrop-blur">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          {parts.length > 0 && (
            <div className="flex items-center gap-1 text-terminal-dim text-xs overflow-hidden">
              {parts.map((part, i) => (
